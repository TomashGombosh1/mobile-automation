 ...
 */
public class DmalfunctionScreen extends AbstractScreen {
    private static final AppElement SCREEN_TITLE = new AppElement(
            "Screen title",
            By.id(formatAndroidId("toolbar_title")),
            MobileBy.iOSNsPredicateString("type == 'XCUIElementTypeStaticText' AND value == 'D/Malfunction'"),
            ScrollTo.NO,
            true);

    public DmalfunctionScreen(final AppiumDriver<MobileElement> driver) {
        super(driver);
    }
